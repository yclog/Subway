...
public class PersonalActivity_Wallet_Payment extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_wallet_payment);
        initView();
    }
    ...
    public void initView(){
        ...
        mIcon_Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PersonalActivity_Wallet_Payment.this.finish();
            }
        });
    }
    /**
